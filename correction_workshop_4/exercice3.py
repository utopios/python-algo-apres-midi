...
while True:
    ...
    if choix == '1' or choix == '2':
        ...
        if type_ressource in inventaire:
            ...
            if choix == '1':
                ...
                inventaire[type_ressource] = 0 if inventaire[type_ressource] < quantite else inventaire[type_ressource] - quantite #<=> max(0, inventaire[type_ressource] - quantite)  # Empêche les valeurs négatives
